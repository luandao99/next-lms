...
import { ChapteVideoForm } from "./_components/chapter-video-form";
  ...
  return (
    <>
      {!chapter.isPublished && (
        <Banner
          variant="warning"
          label="This chapter is unpublicshed. It will not be visible in the course"
        />
      )}
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div className="space-y-4">
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-2xl">Customer Your chapter</h2>
            </div>
            <ChapterTitle
              initialData={chapter}
              courseId={params.courseId}
